                    ...
                    */
                    for (int i = 0; i < objgame.Length; i++)
                    {
                        /*check the winning dog from race using the run method of the
                            class greyhounds and increment the value of the local variable to get the position of the winning dog
                        */
                        if (objgame[i].move())
                        {
                            winningHorse = i + 1;
                            ...
                            //set all the dogs at the starting position after complition the game 
