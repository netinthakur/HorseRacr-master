...
namespace HorseRacr
{
    class Game
    {
        ...
        //object of the random class used for get the random number to change the position of the dogs 
        public Random MyRandom;
        //user define method for running dog from one location to another this method is boolean function that return true or false 
